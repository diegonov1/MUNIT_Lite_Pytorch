...
optimizer_D1 = torch.optim.SGD(D1.parameters(), lr=lr2)
optimizer_D2 = torch.optim.SGD(D2.parameters(), lr=lr2)
...
if pretrained:
    pre_dict = torch.load(weights_ + 'MUNIT_v5_133.pth', map_location='cuda:2')
...
for epoch in range(epoch, n_epochs):
    ...
    if save_model:
        if epoch > 0:
            numeral = epoch - 1
            os.remove(weights_ + f"MUNIT_v5_{numeral}.pth")
    ...
    torch.save({
        ...
        }, weights_ + f"MUNIT_v5_{epoch}.pth")
