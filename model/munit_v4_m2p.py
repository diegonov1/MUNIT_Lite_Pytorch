...
optimizer_D1 = torch.optim.Adam(D1.parameters(), lr=lr2, betas=(b1, b2))
optimizer_D2 = torch.optim.Adam(D2.parameters(), lr=lr2, betas=(b1, b2))
...
for epoch in range(epoch, n_epochs):
    ...
    if save_model:
        if epoch > 0:
            numeral = epoch - 1
            os.remove(weights_ + f"MUNIT_v4_{numeral}.pth")
    ...
    torch.save({
        ...
        }, weights_ + f"MUNIT_v4_{epoch}.pth")
